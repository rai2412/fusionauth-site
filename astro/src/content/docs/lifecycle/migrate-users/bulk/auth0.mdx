...
import PasswordHashNote from 'src/content/docs/lifecycle/migrate-users/bulk/_password-hash-note.mdx';
...
<img src="/img/docs/lifecycle/migrate-users/bulk/find-user-export-extension.png" alt="Finding the import/export extension." width="1200" role="bottom-cropped" />

After you find the extension, install it:

<img src="/img/docs/lifecycle/migrate-users/bulk/user-export-extension-install.png" alt="Installing the import/export extension." width="1200" role="bottom-cropped" />
...
<img src="/img/docs/lifecycle/migrate-users/bulk/user-export-extension-export-run.png" alt="Running the import/export extension." width="1200" role="bottom-cropped" />
...
<img src="/img/docs/lifecycle/migrate-users/bulk/auth0-export-complete.png" alt="View when the the import/export extension is finished." width="1200" role="bottom-cropped" />
...
<img src="/img/docs/lifecycle/migrate-users/bulk/create-ticket-start.png" alt="The first step to getting your password hashes." width="1200" role="top-cropped" />
